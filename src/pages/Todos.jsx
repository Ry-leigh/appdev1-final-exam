    ...
    return (
        ...
        <div id='header' className={`${theme}`}>
            <div className="flexrow-container">
                <button onClick={() => changeTheme("standard")} className="standard-theme theme-selector" />
                <button onClick={() => changeTheme("light")} className="light-theme theme-selector" />
                <button onClick={() => changeTheme("darker")} className="darker-theme theme-selector" />
            </div>
            <h1 id="title">
            Just do it.
            <div id="border" />
